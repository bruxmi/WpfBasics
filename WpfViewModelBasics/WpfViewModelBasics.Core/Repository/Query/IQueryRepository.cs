...
namespace WpfViewModelBasics.Core.Repository.Query
{
	...
	{
		/// <summary>
		/// hronously determines whether any element of a sequence satisfies the given condition.
		/// </summary>
		...
		/// <summary>
		/// hronously counts the items of a sequence.
		/// </summary>
		/// <returns>Returns the amount of items.</returns>
		int Count();

		/// <summary>
		/// hronously counts the items of a sequence that fulfills the given condition.
		/// </summary>
		/// <param name="predicate">The predicate.</param>
		/// <returns>Returns the amount of items.</returns>
		...
		/// <summary>
		/// hronously finds all items of a sequence that satisfy the given condition.
		/// </summary>
		/// <param name="predicate">The predicate.</param>
		...
		/// <summary>
		/// hronously finds all items of a sequence that satisfy the given condition and includes the given navigation property.
		/// </summary>
		...
		/// <summary>
		/// hronously returns the first element of a sequence that satisfies the specified condition.
		/// </summary>
		/// <param name="predicate">The predicate.</param>
		...
		/// <summary>
		/// hronously returns the first element of a sequence that satisfies the specified condition and includes the specified navigation property.
		/// </summary>
		/// <typeparam name="TI">The type of the navigation property.</typeparam>
		/// <param name="predicate">The predicate.</param>
		/// <param name="includes">The navigation property to include..</param>
		...
		/// <summary>
		/// hronously returns a list of all items in the sequence.
		/// </summary>
		/// <returns>Returns the list of items.</returns>
		List<T> GetAll();

		/// <summary>
		/// hronously returns a list of all items in the sequence and includes the specified navigation property.
		/// </summary>
		/// <typeparam name="TI">The type of the navigation property.</typeparam>
		/// <param name="includes">The navigation property to inlcude.</param>
		/// <returns>Returns a list of all items in the sequence.</returns>
		List<T> GetAll<TI>(params Expression<Func<T, TI>>[] includes);

		/// <summary>
		/// hronously returns a sorted list of all items in the sequence per default in ascending order than can be overriden.
		/// </summary>
		...
		List<T> GetAllOrderedBy<TO>(Expression<Func<T, TO>> orderBy, Sort sort = Sort.Asc);
		...
		/// <summary>
		/// hronously returns a paginated and sorted list per default in ascending order of items in the sequence.
		/// </summary>
		/// <param name="orderBy">The navigation property to sort the list.</param>
		...
		/// <summary>
		/// hronously returns a filtered, paginated and sorted list per default in ascending order of items in the sequence.
		/// </summary>
		/// <typeparam name="TO">The type of the navigation property to sort the list.</typeparam>
		...
		List<T> GetFilteredtWithPagingAndOrder<TO>(
		...
		/// <param name="includes">The navigation property to inlcude.</param>
		/// <returns>Returns the filtered, paginated and sorted list of items.</returns>
		List<T> GetFilteredtWithPagingAndOrder<TO, TI>(
			Expression<Func<T, bool>> filter,
			Expression<Func<T, TO>> orderBy,
			int pageIndex = 0,
			int pageSize = int.MaxValue,
		...
		/// <summary>
		/// hronously returns the only element of the sequence that satisfies a given condition 
		...
		/// <summary>
		/// hronously returns the only element of the sequence that satisfies a given condition and includes the specified 
