namespace WpfViewModelBasics.UI.ViewModel
{
    ...
    public class FriendEditViewModel : ViewModelBase, IFriendEditViewModel
    {
        ...
        {
            var friendEntity = this._friendQueryService.GetFriendById(friendId);
        ...
        private async Task OnSaveExecute(object obj)
        {
            ...
            await this._friendCommandService.UpdateFriend(this._mapper.MapTo<FriendVm, Friend>(Friend.Model));
            ...
            {
                await this._addressCommandService.UpdateAddress(this._mapper.MapTo<AddressVm, Address>(Friend.Address.Model));
            }
